      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(230px,1fr))", gap: 16 }}>
        ...
        <div style={sb.card}>
          <div style={{ width: 38, height: 38, borderRadius: "50%", background: "#fdeceb", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
           ...
           <div style={{ fontSize: 36, fontWeight: 800, letterSpacing: "-.02em" }}>{summary.criticalSkillGaps}</div>
        ...
        <div style={sb.card}>
          <div style={{ width: 38, height: 38, borderRadius: "50%", background: "#fdeceb", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
           ...
           <div style={{ fontSize: 36, fontWeight: 800, letterSpacing: "-.02em" }}>{summary.knowledgeConcentrationRisks}</div>
        ...
        <div style={sb.card}>
          <div style={{ width: 38, height: 38, borderRadius: "50%", background: "#f0f0ee", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
           ...
           <div style={{ fontSize: 36, fontWeight: 800, letterSpacing: "-.02em" }}>{summary.activeDevelopmentPlans}</div>
