...
export default function Learning({ loaderData }: Route.ComponentProps) {
  ...
  useEffect(() => { if (isLoaded) { void refresh(); void checkStatus(); } }, [isLoaded, userId, refresh, checkStatus]);
...
>>>>>>> 9c0dc16 (update client and server components)
  return (
    <div style={sb.page} className="kt-page">
      ...
      {context.sample && <Notice>{context.notice || "Sample workforce preview. Sign in with a manager or expert account to save, approve, and assign live records."}</Notice>}
